 ...
 *
 * <p>Usage: OPENAI_API_KEY=sk-... java ai.acolite.agentsdk.examples.BasicTextOutputExample
 */
public class BasicTextOutputExample {
  ...
  public static void main(String[] args) {
    ...
    if (apiKey == null || apiKey.isEmpty()) {
      ...
      System.err.println(
          "Usage: OPENAI_API_KEY=sk-... java ai.acolite.agentsdk.examples.BasicTextOutputExample");
      System.exit(1);
    }
