...
import com.acoliteai.agentsdk.core.memory.Session;
 ...
 *
 * <p>Usage: OPENAI_API_KEY=sk-... java com.acoliteai.agentsdk.examples.MemorySessionExample
 */
public class MemorySessionExample {
  ...
  public static void main(String[] args) {
    ...
    if (apiKey == null || apiKey.isEmpty()) {
      ...
      System.err.println(
          "Usage: OPENAI_API_KEY=sk-... java com.acoliteai.agentsdk.examples.MemorySessionExample");
      System.exit(1);
    }
