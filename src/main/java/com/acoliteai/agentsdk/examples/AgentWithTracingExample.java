 ...
 *
 * <p>Usage: OPENAI_API_KEY=sk-... java com.acoliteai.agentsdk.examples.AgentWithTracingExample
 */
    ...
    try {
      ...
      if (handoffCount > 0) {
        ...
        if (handoff != null) {
          ...
          com.acoliteai.agentsdk.core.tracing.Span<HandoffSpanData> handoffSpan =
              com.acoliteai.agentsdk.core.tracing.Span.<HandoffSpanData>builder()
                  .spanId(TracingUtils.generateSpanId())
                  .traceId(trace.getTraceId())
                  .data(handoffData)
                  .processor(processor)
