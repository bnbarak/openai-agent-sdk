...
@JsonSubTypes({
  @JsonSubTypes.Type(
      value = com.acoliteai.agentsdk.core.RunMessageInputItem.class,
      name = "message_input"),
  @JsonSubTypes.Type(
      value = com.acoliteai.agentsdk.core.RunMessageOutputItem.class,
      name = "message_output"),
  @JsonSubTypes.Type(value = com.acoliteai.agentsdk.core.RunToolCallItem.class, name = "tool_call"),
  @JsonSubTypes.Type(
      value = com.acoliteai.agentsdk.core.RunToolCallOutputItem.class,
      name = "tool_output")
})
