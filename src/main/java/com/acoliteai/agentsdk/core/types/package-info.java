 ...
 *
 * <ul>
 *   <li>{@link com.acoliteai.agentsdk.core.types.TextOutput} - Plain text output from agents
 *   <li>{@link com.acoliteai.agentsdk.core.types.JsonSchemaOutput} - Structured JSON output with
 *       type safety
 *   <li>{@link com.acoliteai.agentsdk.core.types.UnknownContext} - Default context type when no
 *       custom context is needed
 * </ul>
 *
